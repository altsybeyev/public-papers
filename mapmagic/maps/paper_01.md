# Как мы создали топографические карты для пользователей MapMagic. Часть 1: Почему нам понадобились свои карты, обзор стека технологий и откуда берутся данные

Всем привет! Я Влад, сооснователь [MapMagic](https://mapmagic.app/map?b=MM) — [каталога готовых](https://mapmagic.app/discover) маршрутов и планировщика для пеших походов и велопутешествий.

У нас есть как [веб-версия](https://mapmagic.app/map?b=MM) так и [приложения](https://mapmagic.app/apps) для Android и iOS.
